...
static state_type_t elevator_state;
// The variable motor_direction is the overall direction
...
set_state_to_open_door()
{
  ...
  start_door_timer();
  move_after_door_closes = 0; //The direction in which the elevator is going to
                        // move after the door closes, is going to be determined
}
